...
camera.position.set(0, 9, 14); //camera initial position
...
var uSpeed = 0.001;
// var uSpeed = 0.0009; //mouse camera speed
// var uSpeed = 0.0003;

//----------------------------------------------------------------- FOG background

// var setcolor = 0xF02050; //red
// var setcolor = 0xF2F111; //yellow
// var setcolor = 0xFF6347; //light orange
// var setcolor = 0xf5f5f5; //smoke white
// var setcolor = 0xfdddfffd; //smoke white-ish
// var setcolor = 0xfdddfffddd; //smoke cream white
var setcolor = 0x7CB9E8; //aero (blue)
// var setcolor = 0xb475cc; //lusion purple
...
function setTintColor() {
  ...
  setColor = 0x222222; //buildings' color
  return setColor;
};
...
function init() {
  ...
  var pmaterial = new THREE.MeshPhongMaterial({
    color:0x000000, //floor tiles color
    // color:0x222222,
    side:THREE.DoubleSide,
    roughness: 10,
    metalness: 0.6,
...
var createCars = function(cScale = 2, cPos = 20, cColor = 0xFFFF00) {
  ...
  city.add(cElem); //yellow lines dashing
};
